...
import com.foss.aihub.models.Assistant
import com.foss.aihub.models.defaultAssistants
import com.foss.aihub.models.TabType
...
import com.foss.aihub.db.VGHDatabase
import com.foss.aihub.db.VGHQuickPrompt
...
fun MainScreen(pillManager: VGHPillManager, db: VGHDatabase) {
    ...
    when (currentScreen) {
        ...
        Screen.Prompts -> {
            com.foss.aihub.ui.VGHPromptsScreen(
                prompts = prompts,
        ...
        Screen.Notes -> {
            com.foss.aihub.ui.VGHNotesScreen(
                notes = notes,
                onAddNote = { title, content ->
                    scope.launch {
                        val now = System.currentTimeMillis()
                        db.vghDao().insertNote(
                            com.foss.aihub.db.VGHNote(
        ...
        Screen.Bridge -> {
            com.foss.aihub.ui.VGHBridgeScreen(
                onBack = { currentScreen = Screen.Main }
            )
        }
        Screen.Settings -> {
            com.foss.aihub.ui.VGHSettingsScreen(
                onBack = { currentScreen = Screen.Main }
            )
        }
        else -> { /* Other screens */ }
